  ...
  <div id="mainbody"> 
    ...
    <div id="admin">
      <div class="left-menu">
        ...
        <li><a href="email.php" class="active">Send Email</a></li>
        <li><hr /></li>
...
<?php
   ...
   echo $empty_fields_message;
	  ...
	  $resumeinfo =("select full_name, email from resume");
	...
	while( $resumerow = mysql_fetch_assoc($resume) )
	{
	 ...
	 $email = '"'.$resumerow['full_name'].'"<'.$resumerow['email']. ">"; 
