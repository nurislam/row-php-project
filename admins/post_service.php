  ...
  <div id="mainbody"> 
    ...
    <div id="admin">
      <div class="left-menu">
        ...
        <li><hr /></li>
        <li><a href="post_service.php" class="active">Post Services</a></li>
        <li><hr /></li>
      ...
      <div class="admin-body">
        <h1>Post Services</h1>
        <hr/>
        <form  id="form" action="insert_service.php" method="post">
        <table>
            <tr>
              <td width="30">&nbsp;</td>
              <td width="201" align="right">Service Name <span>*</span> :</td>
              <td width="457"><input type="text" name="services_name" /></td>
              <td width="10"></td>
            </tr>
            <tr>
              <td width="30">&nbsp;</td>
              <td width="201" align="right">Description :</td>
              <td width="457"><input type="text" name="description" /></td>
              <td width="10"></td>
            </tr>
            <tr>
              <td width="30">&nbsp;</td>
              <td width="201" align="right">Remark :</td>
              <td width="457"><input name="remark" type="text" /></td>
              <td width="10"></td>
            </tr>
          <!--  <tr>
              <td width="30">&nbsp;</td>
              <td width="201" align="right">Service Type <span>*</span> :</td>
              <td width="457" ><select name="services_type" >
             ...
             <tr>
             <td width="30">&nbsp;</td>
              <td width="201" align="right">Publish <span>*</span> :</td>
              <td width="457" ><select name="status" >
                  <option value="" selected="selected">Select</option>
            ...
            <tr>
              ...
              <td width="457" ><input type="submit" value="Submit" name="submit"  class="btn"/></td>
              <td width="10"></td>
            </tr>
          </table>
          </form>
          <div class="posservice">
          <div class="add_service"> <strong>All Services</strong> (
              <?php 
		...
		echo '<td width="291" height="26" align="center">'.$service['services_name'].'</td>';
		echo '<td width="291" height="26" align="center">'.$service['description'].'</td>';
		echo '<td width="291" height="26" align="center"><a href="javascript:dell('.$service['services_id'].')" onclick="dell ('.$service['services_id'].');  return false" id="'.$service['services_id'].'"><img src="images/delete.png" title="Delete type" /></a></td>';
