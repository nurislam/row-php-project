  ...
  <div id="mainbody"> 
    ...
    <div id="admin">
      ...
      <div class="admin-body">
        <h1><strong>View Applicants</strong></h1>
        <hr />
        <div class="work-admin">
          <?php 
	   $jobs = mysql_query("SELECT job_title FROM jobinformation

WHERE jobinformation_id = '{$_GET['id']}'");

$job_title = mysql_fetch_array($jobs);
	   ?>
          <strong>Job Title : </strong> <span><?php echo $job_title['job_title'];?></span>
          <table>
          	<tr >
              <td width="229" height="15" align="center"></td>
              <td width="244" align="center"></td>
              <td width="211" align="center"></td>
            </tr>
            <tr bgcolor="#cccccc">
              <td width="229" height="26" align="center"><strong>Full Name</strong></td>
              <td width="244" align="center"><strong>Email Address</strong></td>
              <td width="211" align="center"><strong>Contact Number</strong></td>
            </tr>
          </table>
...
WHERE jobinformation.jobinformation_id = '{$_GET['id']}'");

 while($app = mysql_fetch_array($applicant)){
			
		echo '<tr bgcolor="#f5f6f5">';
			echo '<td width="229" height="26" align="center"><a href="javascript:makeRequest('."'file.php?id=".$app['resume_id']."'".')">'.$app['full_name'].'</a></td>';
			echo '<td width="244" align="center">'.$app['email'].'</td>';
			echo '<td width="211" align="center">'.$app['contact_number'].'</td>';
	 echo '</tr>';
