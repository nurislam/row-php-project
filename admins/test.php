	...
	$(document).ready(function()
{
		...
		//console.log($(this).prop.('href'));
         ...
         var id = ($(this).attr("href"));
		   ...
		   // $("#dialog-message").get(0).innerHTML=id;
		   //alert($(this).attr("href")).replace(/?id=/,'');
  ...
  ?>
   ...
   <table>
   		<tr>
            ...
            <td><input name="from" id="from" type="text" class="" /></td>
        </tr>
        <tr>
        	<td align="right">To:</td>
            <td><input name="tomsg" id="tomsg" type="text" class="" value="<?php echo $email['email'];?>"/></td>
        </tr>
        <tr>
    ...
    <span class="error" style="display:none; color:red;"> Please Enter Valid Data All Field </span>
<span class="success" style="display:none"> Your Message Successfully Send !</span>
    </form>
    </div>
  ...
  <h1><strong>View All Applicants</strong><span> (
        ...
        <div class="work-admin">
          <table>
            <tr bgcolor="#cccccc">
              <td width="146" height="26" align="center"><strong>Full Name</strong></td>
              <td width="224" align="center"><strong>Email Address</strong></td>
              <td width="80" align="center"><strong>Type</strong></td>
              <td width="74" align="center"><strong>App jobs</strong></td>
		...
		echo '<tr bgcolor="#f5f6f5" class="remove">';
			...
			if($app['TotalJob']){
				...
				echo '<td width="43" align="center" ><a href="active.php?id= '.$app['resume_id'].'">Deactive</a></td>';
				echo '<td align="center"><a href="" title="Not Service"><img src="images/minus.png" title="No Service" /></a></td>';
				}
			echo '<td align="center"><a href="?id='.$app['resume_id'].'" class="show" ><img src="images/sms.png" title="Send message" /></a></td>';	
