    ...
    <div id="admin">
      <div class="left-menu">
        <ul>
          ...
          <li><a href="postjobs.php"  class="active">Post jobs</a></li>
          <li>
            <hr />
          </li>
      ...
      <div class="admin-body">
        <h1>Post New Job</h1>
        <hr />
        <form  id="form" action="insertjob.php" method="POST">
          <table>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Job title <span>*</span> :</td>
              <td width="381"><input type="text" name="job_title" /></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Job vacancies :</td>
              <td width="381"><input type="text" name="job_vacancies" />
            ...
            <tr>
              ...
              <td width="381"><input name="job_source" type="text" /></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Job location :</td>
              <td width="381"><input name="job_location" type="text" /></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Posting date :</td>
              <td width="381"><input name="posting_date" type="text" />
            ...
            <tr>
              ...
              <td width="381"><input name="expr_date" type="text" />
                <span>Year-Month-Day </span></td>
              <td width="12"></td>
            </tr>
            <tr>
              ...
              <td width="381"><input name="salary_range" type="text" /></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Job description :</td>
              <td width="381"><textarea name="job_description" cols="" rows=""  class="textarea"></textarea></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Educational requirements<span>*</span> :</td>
              <td width="381"><textarea name="educational_requirements" cols="" rows=""  class="textarea"></textarea></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Experience requirements :</td>
              <td width="381"><textarea name="experience_requirements" cols="" rows=""  class="textarea"></textarea></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Additional requirements :</td>
              <td width="381"><textarea name="additional_requirements" cols="" rows=""  class="textarea"></textarea></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Other benefits :</td>
              <td width="381"><textarea name="other_benefits" cols="" rows=""  class="textarea"></textarea></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Apply instruction :</td>
              <td width="381"><textarea name="apply_instruction" cols="" rows=""  class="textarea"></textarea></td>
              <td width="12"></td>
            </tr>
            <tr>
              <td width="27">&nbsp;</td>
              <td width="199" align="right">Publish <span>*</span> :</td>
